...
LDFLAGS="-s -w "
LDFLAGS+="-X github.com/medik8s/customized-user-remediation/version.Version=${VERSION} "
LDFLAGS+="-X github.com/medik8s/customized-user-remediation/version.GitCommit=${COMMIT} "
LDFLAGS+="-X github.com/medik8s/customized-user-remediation/version.BuildDate=${BUILD_DATE} "
